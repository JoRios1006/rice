...
static const Layout layouts[] = {
	...
	{ "'TIL",	tile },			/* Default: Master on left, slaves on right */
	{ "'BST",	bstack },		/* Master on top, slaves on bottom */

	{ "'SPR",	spiral },		/* Fibonacci spiral */
	{ "'DWN",	dwindle },		/* Decreasing in size right and leftward */

	{ "'DCK",	deck },			/* Master on left, slaves in monocle-like mode on right */
	{ "'MNC",	monocle },		/* All windows on top of eachother */

	{ "'CMS",	centeredmaster },		/* Master in middle, slaves on sides */
	{ "'CFL",	centeredfloatingmaster },	/* Same but master floats */
